...
const Button = ({ 
  ...
  const baseStyles = 'inline-flex items-center justify-center px-6 py-2 rounded-lg font-medium tracking-wide transition-all duration-300 transform active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed no-star-interaction outline-none focus-visible:ring-1 focus-visible:ring-brand-accent/50';
